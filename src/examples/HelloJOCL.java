...
{
    private static String clCode = "// OpenCL Kernel Function for element by element vector addition\n" +
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        try
        {
            ...
            int elementCount =  200000000;                                  // Length of arrays to process
            int localWorkSize = min(device.getMaxWorkGroupSize(), 256);  // Local work size dimensions
            int globalWorkSize = roundUp(localWorkSize, elementCount);   // rounded up to the nearest multiple of the localWorkSize

            // load sources, create and build program
            CLProgram program = context.createProgram(clCode).build();
            ...
            out.println("computation took: " + time + " nanos");
